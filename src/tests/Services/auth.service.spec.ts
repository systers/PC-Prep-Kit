...
const baseAuthUrl = environment.baseURL + environment.authEndpoint;
...
const loginAuthUrl = baseAuthUrl + 'login';
const
  logoutAuthUrl = baseAuthUrl + 'logout';
const authenticatedApi = baseAuthUrl + 'authenticated';
